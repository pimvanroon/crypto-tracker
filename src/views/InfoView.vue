        ...
        <div class="row">
          ...
          <div class="col-md-4 mb-3">
            <div class="info-card justify-content-center">
              ...
              <div><span class="info-label">24H HIGH </span>{{ ticker.high | priceformat }}<span class="small">
                  {{currency.quote}}</span></div>
              <div><span class="info-label">24H LOW </span>{{ ticker.low | priceformat }}<span class="small">
                  {{currency.quote}}</span></div>
